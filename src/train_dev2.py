...
def main(config):
    ...
    if config.experiment.train_strategy == "fsdp":
        ...
        strategy = DeepSpeedStrategy(stage=3, offload_optimizer=True, offload_params_device='cpu', offload_parameters=True, 
    ...
    pl_trainer = Trainer(
        ...
        logger=tb_logger,
        callbacks=[lr_monitor, valid_lm_loss_ckpt_monitor, token_monitor],
