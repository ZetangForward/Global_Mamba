...
try:
    from models.selective_scan_interface_origin import selective_scan_fn
    from models.selective_scan_interface_origin import mamba_inner_fn
except ImportError:
...
class MambaMixer(nn.Module):
    def __init__(self, config, layer_idx, max_seq_len=4096, conv1d_configs=None):
        super().__init__()
...
class MambaBlock(nn.Module):
    def __init__(self, config, layer_idx, use_relative_position=False, max_position_embeddings=None, 
                 use_abs_position=False, conv1d_configs=None):
        super().__init__()
        self.config = config
        self.layer_idx = layer_idx
...
class CustomMambaModel(MambaPreTrainedModel):
    def __init__(self, config, use_relative_position=False, max_position_embeddings=None, 
                 use_abs_position=False, conv1d_configs=None) -> None:
...
class CustomMambaForCausalLM(MambaPreTrainedModel):
    ...
    def __init__(self, config, use_relative_position=False, max_position_embeddings=None, 
                 use_abs_position=False, custom_conv1d_configs=None, delta_ratio=0) -> None:
        super().__init__(config)
        self.config = config
        
        self.backbone = CustomMambaModel(config)
