...
mn=mamba-130m-hf
en=mamba-130m-hf-v0-position-shuffle
...
torchrun --nnode=1 --nproc_per_node=${num_devices} --master_port ${random_port} src/train_dev2.py \
    ...
    --version $en \
    --delta_ratio 0 \
    --data_dir MQAR/analysis/position-shuffle/mqar_128-8-nonoise;
...
python src/test_dev2.py \
    ...
    --data_dir MQAR/analysis/position-standard/mqar_128-8-nonoise;
