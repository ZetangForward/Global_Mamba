...
en="mamba-370m-hf-longconv-2048-512-from-sk-15b_post_train"
...
torchrun --nnode=1 --nproc_per_node=${num_devices} --master_port ${random_port} src/train_dev2.py \
    ...
    --monitor_metric "valid_lm_loss" --accumulate_grad_batches 8 --max_epochs 10 \
    --lr_rate 8e-4 \
    ...
    --ckpt_path "/nvme1/zecheng/ckpt/mamba-370m-hf-longconv-2048-512--from-sk-15b/version_1/checkpoints/last.ckpt";
