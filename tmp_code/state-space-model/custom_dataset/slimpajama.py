...
def main():
    # data = datasets.load_dataset("/nvme1/zecheng/data/slim_pajama_chunk1/valid")
    # max_seq_length = 1024  
    # tokenizer = AutoTokenizer.from_pretrained("/nvme/hf_models/mamba-370m-hf")
    # processed_dataset = Slimpajama.preprocess_data(data, tokenizer, max_seq_length, num_workers=48)
    # processed_dataset.save_to_disk("/nvme1/zecheng/data/slim_pajama_chunk1/valid")
    
    data = datasets.load_dataset("/nvme1/data/SlimPajama-6B/data")
    max_seq_length = 2048  
    tokenizer = AutoTokenizer.from_pretrained("/nvme/hf_models/mamba-370m-hf")
    processed_dataset = Slimpajama.preprocess_data(data, tokenizer, max_seq_length, num_workers=48)
    processed_dataset.save_to_disk("/nvme1/data/SlimPajama-6B/processed_data_2048")
